...
def parse_args():    
    ...
    parser.add_argument('-nii_path', type=str, default=None, help='single NIfTI file path for inference')
    # ★ 新增：切片方向，axial=橫斷面(預設), coronal=冠狀面(前後), sagittal=矢狀面(左右)
    parser.add_argument('-axis', type=str, default='axial', choices=['axial', 'coronal', 'sagittal'],
                        help='slicing axis for BTCV: axial (default), coronal, sagittal')
